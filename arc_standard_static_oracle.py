...
def main():
    ...
    train_data = Dataset('no_nynorsk-ud-train-projectivized.conllu')
    dev_data = Dataset('no_nynorsk-ud-dev.conllu')
    ...
    with open('no_nynorsk-ud-train-projectivized-retagged.conllu', 'wt', encoding="utf-8") as target:
        for sentence in TaggedDataset('no_nynorsk-ud-train-projectivized.conllu'):
    ...
    with open('no_nynorsk-ud-dev-retagged.conllu', 'wt', encoding="utf-8") as target:
    ...
    train_data_retaged = Dataset(
        'no_nynorsk-ud-train-projectivized-retagged.conllu')
    dev_data_retaged = Dataset('no_nynorsk-ud-dev-retagged.conllu')
